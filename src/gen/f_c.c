...
#else
  #define CASADI_PREFIX(ID) f_c_ ## ID
#endif
...
CASADI_SYMBOL_EXPORT casadi_int f_c(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, void* mem){
...
CASADI_SYMBOL_EXPORT casadi_int f_c_n_in(void) { return 7;}
...
CASADI_SYMBOL_EXPORT casadi_int f_c_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 7;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
